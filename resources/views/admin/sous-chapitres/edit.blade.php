<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-xl text-gray-900">Modifier : {{ $sousChapitre->titre }}</h2>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <form action="{{ route('admin.sous-chapitres.update', $sousChapitre) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="titre" name="titre" type="text" class="mt-1 block w-full" :value="old('titre', $sousChapitre->titre)" required />
