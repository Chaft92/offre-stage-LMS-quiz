    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">D&eacute;couvrez vos cours et progressez</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="mt-4 flex items-center gap-3 text-xs text-gray-400">
                                    ...
                                    <span>&middot; {{ $formation->chapitres->count() }} chapitre(s)</span>
                                </div>
                            </div>
                ...
                @empty
                    <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 col-span-2 text-center">
                        ...
                        <p class="text-gray-500">Vous n'&ecirc;tes inscrit &agrave; aucune formation pour le moment.</p>
                    </div>
                @endforelse
            </div>
        </div>
